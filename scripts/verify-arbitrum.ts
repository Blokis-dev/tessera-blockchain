...
async function main() {
  console.log("🔍 Verifying CertNFT_Arbitrum contract on Arbiscan...");
  ...
  try {
    ...
    deploymentData.explorerUrl = `https://sepolia.arbiscan.io/address/${contractAddress}`;
    ...
    if (error.message.includes("already verified")) {
      ...
      console.error("💡 Make sure ARBISCAN_API_KEY is set in your .env file");
    } else {
      throw error;
    }
  }
