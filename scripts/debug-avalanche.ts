...
async function main() {
  console.log("🔍 Diagnosticando contrato de Avalanche...");

  // Cargar la dirección del contrato deployado de AVALANCHE
  ...
  // Conectar al contrato de AVALANCHE
  ...
  try {
    ...
    const testParams = {
      ...
      studentName: "Test Student Avalanche",
      courseName: "Test Course Avalanche",
      institutionName: "Test Institution",
      tokenURI: "https://test.com/metadata",
      ipfsHash: "QmTestHashAvalanche",
